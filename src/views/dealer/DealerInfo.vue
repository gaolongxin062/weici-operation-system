      ...
      <el-dialog v-model="dialogAdd" top="5vh" :title="dialogTitle" width="800" :show-close="false" :destroy-on-close="true"
        ...
        <el-form :inline="true" ref="formref" id="form" :model="dialogForm" size="large" label-width="100px"
          ...
          <el-form-item v-if="dialogType !== 'edit'" label="所属上级">
            <el-cascader style="width:250px" :disabled="dialogType === 'power'" v-model="dialogForm.parent_id" clearable :options="dealerList" :props="cascaderProps"
...
const changeDealer = (val) => {
  console.log('22222222222222222', val)
  getRoleList(val)
  getAreaTree(val)
  dialogForm.role_id = ''
  dialogForm.area_ids = ''
...
const changeRole = (val) => {
  ...
  // dialogForm.sub_role_ids = ''
  // getRoleList(val, dialogForm.role_id)
