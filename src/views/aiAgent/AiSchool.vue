<template>
  <div class="page">
        ...
        <div style="margin-right: 20px;display: flex;align-items: center;flex-wrap: wrap;">
          ...
          <el-form-item label="区县">
            <el-select filterable clearable v-model="searchForm.county_id" placeholder="请选择内容" style="width: 240px">
              <el-option v-for="item in countyList" :key="item.id" :label="item.county" :value="item.id" />
            </el-select>
          </el-form-item>

          <el-form-item label="学校">
            <el-input style="width: 240px" class="search-input" clearable placeholder="请输入内容"
    ...
    <el-table :data="schoolList" class="table-info" :max-height="screenHeight" v-loading="loading"
    ...
    <div class="add-dialog">
      <el-dialog v-model="dialogAdd" :title="dialogTitle" width="500" :show-close="false" :destroy-on-close="true"
        @close="closeDialogAdd">
        <el-form :inline="true" ref="formref" id="form" :model="dialogForm" size="large" label-width="100px"
          :disabled="dialogFormDisabled" :rules="rules">
          <el-form-item label="省" prop="province_id">
            <el-select filterable clearable v-model="dialogForm.province_id" placeholder="请选择内容" style="width: 240px"
              @change="changeDialogProvince">
              <el-option v-for="item in dialogProvinceList" :key="item.id" :label="item.province" :value="item.id" />
            </el-select>
          </el-form-item>
          <el-form-item label="市" prop="city_id" label-width="100px">
            <el-select filterable clearable v-model="dialogForm.city_id" placeholder="请选择内容" style="width: 240px"
              @change="changeDialogCity">
              <el-option v-for="item in dialogCityList" :key="item.id" :label="item.city" :value="item.id" />
            </el-select>
          </el-form-item>
          <el-form-item label="区县" prop="county_id" label-width="100px">
            <el-select filterable clearable v-model="dialogForm.county_id" placeholder="请选择内容" style="width: 240px">
              <el-option v-for="item in dialogCountyListt" :key="item.id" :label="item.county" :value="item.id" />
            </el-select>
          </el-form-item>
          <el-form-item label="学校" prop="school" label-width="100px">
            <el-input class="search-input" clearable placeholder="请输入" :maxlength="50" v-model="dialogForm.school">
            </el-input>
          </el-form-item>
        </el-form>
