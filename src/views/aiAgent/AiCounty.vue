<template>
  <div class="page" :class="isMobileDevice ? 'mobile-page' : 'computer-page'" >
    ...
    <el-table :data="countyList" class="table-info" :max-height="screenHeight" v-loading="loading"
        ...
        <el-form :inline="true" ref="formref" id="form" :model="dialogForm" size="large" label-width="100px"
          ...
          <el-form-item label="省" prop="province_id">
            <el-select v-model="dialogForm.province_id" placeholder="请选择内容" style="width: 240px"
              @change="changeDialogProvince" clearable filterable>
          ...
          <el-form-item label="区县" prop="county" label-width="100px">
            <el-input class="search-input" clearable placeholder="" :maxlength="50" v-model="dialogForm.county">
            </el-input>
          </el-form-item>
        </el-form>
