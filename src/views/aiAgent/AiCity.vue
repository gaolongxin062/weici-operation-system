<template>
  <div class="page">
      ...
      <div style="display: flex;align-items: center;">
        <div style="margin-right: 20px;">
          ...
          <el-form-item label="市">
            <el-input style="width: 240px" class="search-input" clearable placeholder="请输入内容" v-model="searchForm.city">
            </el-input>
          </el-form-item>
          <el-form-item>
    ...
    <el-table :data="cityList" class="table-info" :max-height="screenHeight" v-loading="loading"
      ...
      <el-dialog v-model="dialogAdd" :title="dialogTitle" width="500" :show-close="false" :destroy-on-close="true"
        ...
        <el-form :inline="true" ref="formref" id="form" :model="dialogForm" size="large" label-width="100px"
          ...
          <el-form-item label="市" prop="city" label-width="100px">
            <el-input class="search-input" clearable placeholder="" :maxlength="50" v-model="dialogForm.city">
            </el-input>
          </el-form-item>
        </el-form>
